...
import static com.poshelyuk.st.algorithm.algorithm.AlgorithmsNameConstant.TIMSORT;
...
public class Timsort implements Sortable {
    ...
    private void insertionSort(int[] arr, int left,
                               int right) {
    ...
    private void merge(int[] arr, int l,
                       int m, int r) {
